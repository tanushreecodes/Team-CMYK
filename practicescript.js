...
class ReadingPractice {
    ...
    try {
        ...
        this.startSpeechRecognition((text) => {
            console.log("Paragraph spoken:", text);
            const accuracy = this.calculateAccuracy(this.paragraph, text);
            ...
            if (feedbackDescElement) {
                feedbackDescElement.textContent = `Accuracy: ${accuracy}%`;
            }
    ...
    try {
        ...
        this.startSpeechRecognition((text) => {
            ...
            const accuracy = this.calculateAccuracy(currentSentence, text);
